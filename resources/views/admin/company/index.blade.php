    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h4 class="text-dark">{{__('Company Setting')}}</h4>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('company_index') }}">{{__('Company Setting')}}</a></div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(['route'=>'company_store','method'=>'POST','enctype'=>'multipart/form-data']) !!}
                            @csrf
                            <div class="row">

                                <div class="form-group col-md-6">
                                    {{Form::label('name',__('Company Name'))}}
                                    {{Form::text('company_name',\App\Models\Utility::settingdata('company_name'),array('class'=>'form-control','placeholder'=>'Enter Your Company Name'))}}
                                    @error('company_name')
                                ...
                                <div class="form-group col-md-6">
                                    {{Form::label('name',__('Company Email'))}}
                                    {{Form::text('company_email',\App\Models\Utility::settingdata('company_email'),array('class'=>'form-control','placeholder'=>'Enter Your Company Email'))}}
                                    @error('company_email')
                                    <span class="invalid-name" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    {{Form::label('name',__('Company Phone'))}}
                                    {{Form::text('company_phone',\App\Models\Utility::settingdata('company_phone'),array('class'=>'form-control','placeholder'=>'Enter Your Company Phone'))}}
                                    @error('company_phone')
                                    <span class="invalid-name" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    {{Form::label('name',__('Company Address'))}}
                                    {{Form::textarea('company_address',\App\Models\Utility::settingdata('company_address'),array('class'=>'form-control','placeholder'=>'Enter Your Company Address'))}}
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{Form::text('city',\App\Models\Utility::settingdata('city'),array('class'=>'form-control','placeholder'=>'Enter Your City'))}}
                                    @error('city')
                                    <span class="invalid-name" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{Form::text('state',\App\Models\Utility::settingdata('state'),array('class'=>'form-control','placeholder'=>'Enter Your State'))}}
                                    @error('state')
                                    <span class="invalid-name" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{Form::text('country',\App\Models\Utility::settingdata('country'),array('class'=>'form-control','placeholder'=>'Enter Your Country'))}}
                                    @error('country')
                                    <span class="invalid-name" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    {{Form::label('name',__('Zip Code'))}}
                                    {{Form::text('zip_code',\App\Models\Utility::settingdata('zip_code'),array('class'=>'form-control','placeholder'=>'Enter Your Zip Code'))}}
                                    @error('zip_code')
                                    <span class="invalid-name" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    {{Form::label('name',__('Currency Symbol'))}}
                                    {{Form::text('company_symbol',\App\Models\Utility::settingdata('company_symbol'),array('class'=>'form-control','placeholder'=>'Enter Your Company Symbol'))}}
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="timezone" class="form-control" id="">
                                        ...
                                        <option value="America/Araguaina" selected>(GMT-3:00) America/Araguaina (Brasilia Time)</option>
                                ...
                                <div class="form-group col-md-3">
                                    {{Form::label('name',__('Company Date Formate'))}}
                                    <div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" name="date" value="M j,y"  {{ \App\Models\Utility::settingdata('date') == value('M j,y') ? 'checked': '' }} >
                                            <label for="" class="">{{ date('M j,Y') }} </label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" name="date" value="Y-m-d"{{ \App\Models\Utility::settingdata('date') == value('Y-m-d') ? 'checked': '' }} >
                                            <label for="" class="">{{ date('Y-m-d') }}</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" name="date" value="d-m-Y" {{ \App\Models\Utility::settingdata('date') == value('d-m-Y') ? 'checked': '' }} >
                                            <label for="" class="">{{ date('d-m-Y') }}</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" name="date" value="m-d-y"  {{ \App\Models\Utility::settingdata('date') == value('m-d-y') ? 'checked': '' }}>
                                            <label for="" class="">{{ date('m-d-y') }}</label>
                                        </div>
                                ...
                                <div class="form-group col-md-3">
                                    {{Form::label('name',__('Company Time Formate'))}}
                                    <div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" name="time" value="H:i" {{ \App\Models\Utility::settingdata('time') == value('H:i') ? 'checked': '' }} >
                                            <label for="" class="">{{ date('H:i') }}</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" name="time" value="g:i A" {{ \App\Models\Utility::settingdata('time') == value('g:i A') ? 'checked': '' }}  >
                                            <label for="" class="">{{ date('g:i A') }}</label>
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="language" id="" class="form-control">
                                        <option value="">{{ \App\Models\Utility::settingdata('language') }}</option>
                                        @foreach($language as $language_list)
                                            <option value="{{ $language_list->language_name }}">{{ $language_list->language_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('company_symbol')
                                    <span class="invalid-name" role="alert">
